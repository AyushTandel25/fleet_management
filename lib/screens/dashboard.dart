...
class _DashBoardState extends State<DashBoard> {
  ...
  String arrangeDate(DateTime date){
    String arrangedDate;
    var day=date.day.toString().length>1 ? date.day.toString() : "0"+date.day.toString();
    var month=date.month.toString().length>1 ? date.month.toString() : "0"+date.month.toString();
  ...
  Future getList(DateTime date) async{
    ...
    var response=await getSchedule(startTime, endTime, userRp.currentUser.value.userId);
    setState(() {
      spinner=false;
    });
